...
const OnScreenTutorials: React.FC = () => {
    const [selectedTutorial, setSelectedTutorial] = useState(tutorialCategories[0].tutorials[0]);
    const [currentStep, setCurrentStep] = useState(0);

    const handleSelectTutorial = (tutorial: typeof tutorialCategories[0]['tutorials'][0]) => {
